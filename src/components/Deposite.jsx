import { Box, Button, Flex, FormControl, FormLabel, Heading, Input, Table, TableContainer, Tbody, Td, Tr, useToast } from "@chakra-ui/react"
...
function Deposite() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const res = await axios.patch("http://localhost:5000/bank/editAccount", formData);
    ...
    const { accountNo, password, amount } = formData;
